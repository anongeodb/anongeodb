...
public class GeoDBParameters {

	public static final Logger log = LoggerFactory.getLogger(GeoDBParameters.class);
	...
	static {
		GenericProperties properties = GeoDBProperties.getGeoDBProperties();
		...
		log.trace("GeoDB Properties Loaded.");
	}
