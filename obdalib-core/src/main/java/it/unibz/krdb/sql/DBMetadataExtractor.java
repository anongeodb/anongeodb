...
public class DBMetadataExtractor {
	...
	public static void createGeoDBMetadata(DBMetadata metadata, Set<RelationID> realTables) throws SQLException {
		...
		for (RelationID seedId : seedRelationIds) {
			...
			if(seedId.getTableName().startsWith(GeoDBParameters.GEOMETRIES_TABLE)) {
				QuotedID attributeId3 = QuotedID.createIdFromDatabaseRecord(GeoDBParameters.GEOMETRIES_FIRST_COLUMN);
				if (printouts)
				...
				QuotedID attributeId4 = QuotedID.createIdFromDatabaseRecord(GeoDBParameters.GEOMETRIES_SECOND_COLUMN);
				if (printouts)
				...
				QuotedID attributeId5 = QuotedID.createIdFromDatabaseRecord(GeoDBParameters.GEOMETRIES_THIRD_COLUMN);
				if (printouts)
