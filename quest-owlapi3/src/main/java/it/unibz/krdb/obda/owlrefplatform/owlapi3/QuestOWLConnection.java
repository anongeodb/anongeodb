...
public class QuestOWLConnection implements AutoCloseable {
	...
	public QuestOWLStatement createGeoDBStatement(NodeSelectivityEstimator nse) throws OWLException {
			return new QuestOWLStatement(conn.createGeoDBStatement(nse), this);
	}
